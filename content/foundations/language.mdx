...
<DoDontContainer>
  <Do>
    <img alt="" src={Language06} width="100%" />
    <Caption>Use a flag for modifiers of actions</Caption>
  </Do>
  <Dont>
    <img alt="" src={Language03} width="100%" />
...
<DoDontContainer>
  <Do>
    <img alt="" src={Language05} width="100%" />
    <Caption>Use language that can't be misconstrued</Caption>
  </Do>
  <Dont>
    <img alt="" src={Language02} width="100%" />
    <Caption>
      Avoid language that can be interpreted in multiple ways ("open in browser"
